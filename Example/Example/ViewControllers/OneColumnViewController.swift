...
class OneColumnViewController: UIViewController {
    static func getInstance(_ list: [PXLPhoto]) -> OneColumnViewController {
        let vc = OneColumnViewController(nibName: "EmptyViewController", bundle: Bundle.main)
        vc.photos = list
        return vc
    }
...
extension OneColumnViewController: PXLPhotoViewDelegate {
...
extension OneColumnViewController: PXLGridViewDelegate {
